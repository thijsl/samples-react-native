...
This is an sample app of THEOplayer - React Native in Swift 4.2 - Xcode 10.1. 

Note: The above project is supported on in Xcode 10.1 and below. THEOplayer SDK supports Swift 4.2 only until version 2.59 or lower. 
